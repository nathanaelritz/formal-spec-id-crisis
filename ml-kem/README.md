...
To run the model and evaluate all properties:
proverif205 -lib tls-lib-simple.pvl -lib sanity.pvl -lib queries.pvl -html traces tls13-multiagent.pv 2>&1 | tee log-mlkem-binder.txt
```
